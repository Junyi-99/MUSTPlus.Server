...
COES_LOGIN = 'https://coes-stud.must.edu.mo/coes/login.do'
COES_STUDENT_INFO_NAME_AND_BIRTHDAY = 'https://coes-stud.must.edu.mo/coes/StudentInfo.do'
COES_STUDENT_INFO_FACULTY_AND_MAJOR = 'https://coes-stud.must.edu.mo/coes/StudyPlanGroup.do'
COES_LOGOUT = 'https://coes-stud.must.edu.mo/coes/logout.do'
COES_TIMETABLE = 'https://coes-stud.must.edu.mo/coes/AcademicRecordsForm.do'
